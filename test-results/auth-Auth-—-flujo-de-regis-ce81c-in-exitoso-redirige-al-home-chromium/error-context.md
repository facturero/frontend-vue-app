...
- Name: auth.spec.ts >> Auth — flujo de registro e inicio de sesión >> login exitoso redirige al home
- Location: e2e\specs\auth.spec.ts:28:3
  ...
  - generic [ref=e8]:
    - generic [ref=e9]:
      ...
      - generic [ref=e14]:
        - generic [ref=e16]:
          - generic [ref=e17]:
            - generic [ref=e18]: admin@admin.com
